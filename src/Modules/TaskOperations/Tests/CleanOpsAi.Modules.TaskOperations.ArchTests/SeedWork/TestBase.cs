...
using CleanOpsAi.Modules.TaskOperations.Application;
using CleanOpsAi.Modules.TaskOperations.Domain;
using CleanOpsAi.Modules.TaskOperations.Infrastructure;
using NetArchTest.Rules;
using System.Reflection;

namespace CleanOpsAi.Modules.TaskOperations.ArchTests.SeedWork
{
