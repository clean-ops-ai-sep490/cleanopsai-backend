...
namespace CleanOpsAi.Modules.ServicePlanning.Application.Common.Interfaces.Services
{
	public interface IStepService
	{
		...
		Task<StepDto> CreateNewStep(StepCreateDto dto, CancellationToken ct = default);

		Task<StepDto> UpdateStep(Guid id, StepUpdateDto dto, CancellationToken ct = default);
