using CleanOpsAi.Modules.ServicePlanning.Application;
using CleanOpsAi.Modules.ServicePlanning.Domain;
using CleanOpsAi.Modules.ServicePlanning.Infrastructure;
using NetArchTest.Rules;
using System.Reflection;

namespace CleanOpsAi.Modules.ServicePlanning.ArchTests.SeedWork
{
