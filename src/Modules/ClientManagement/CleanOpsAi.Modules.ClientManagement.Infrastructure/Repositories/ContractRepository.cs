...
namespace CleanOpsAi.Modules.ClientManagement.Infrastructure.Repositories
{
    public class ContractRepository : IContractRepository
    {
        ...
        {
            var contract = _dbContext.Set<Contract>().FirstOrDefault(c => c.Id == id);
            return contract;
        ...
        {
            var constracts = _dbContext.Set<Contract>().ToList();
            return constracts;
        }
        ...
        {
            var query = _dbContext.Set<Contract>().AsQueryable();
